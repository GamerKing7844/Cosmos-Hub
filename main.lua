...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      Note = "Go to the GitHub Repo for the key. Please also note the GitHub Repo is the only legit place to find the Cosmos Hub, if you got it anywhere else, leave immediately!!!", -- Use this to tell the user how to get a key
